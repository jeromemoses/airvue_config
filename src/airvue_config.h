...
// TVOC commands
const byte TVOC_start_QAmode_cmd[] = {0XFF, 0x01, 0x78, 0x41, 0x00, 0x00, 0x00, 0x00, 0x46};
const byte TVOC_read_cmd[] = {0XFF, 0x01, 0x86, 0x00, 0x00, 0x00, 0x00, 0x00, 0x79};
...
/**
 *To control replay - connected to stm32
 * @param relay-1 control bit -> 1=ON , 0=OFF 
 * @param relay-2 control bit -> 1=ON , 0=OFF
*/
void stm_relay(bool , bool);

/**
 * TVOC sensor read function
